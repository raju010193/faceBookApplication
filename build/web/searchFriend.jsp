<%-- 
    ...
    Created on : Mar 13, 2017, 4:07:28 PM
    Author     : Kiran
--%>
    ...
    <body>
        ...
        <div class="row">
            <div class="large-8 large-centered columns"style="margin-top: 50px">
                <form id="loginForm" action="search.jsp" method="post">

                    <p class="text-left" style="font-weight: bold;">Find Friends Here</p>
                    <hr style="border: 1px solid green;">

                    <div class="row collapse">
                        <div class="small-10 columns">
                            <input type="text" name="username"placeholder="Enter Name to find frieds">
                        </div>
                ...
                <% String adminMessage = request.getParameter("status");
