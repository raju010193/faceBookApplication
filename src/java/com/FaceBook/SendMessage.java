    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        try {
            ...
            if (!isMultipart) {
                ...
                while (itr.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        String ipath=request.getRealPath("./messages");
            ...
            strQuery = "insert into message (msgfrom,msgto,msg,file)values('" + array.get(0) + "','" + array.get(1) + "','" + array.get(2) + "','" + messages.get(0) + "')";
