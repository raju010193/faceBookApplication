<%-- 
    Document   : profileApps
    Created on : Mar 13, 2017, 3:02:25 PM
    Author     : Kiran
--%>
    ...
    <body>
        ...
        <div class="row">
            <div class="large-10 large-centered columns">
                <p class="text-center" style="font-weight: bold;margin-top: 50px;font-size: 25px;color: brown">My Profile Applications</p>
                <hr style="border: 1px solid green;">
                <p class="text-center" style="font-weight: bold;font-size: 13px">The list of applications and games in my profile.</p>

                <%
                    Statement st = null;
//String status=request.getParameter("status");
                    String username = session.getAttribute("username").toString();
                    String proapps = "Select * from proapp where username='" + username + "' ";

                    st = con.createStatement();
                    ResultSet rs = st.executeQuery(proapps);
                    while (rs.next()) {

                        String appname = rs.getString(4);
                        String appurl = rs.getString(6);
                        String appicon = rs.getString(7);

                %>
                <table>
                    <tbody>
                        <tr  ><td width="250">  <a href="./apps/<%=appicon%>" class="b-link-stripe b-animate-go  swipebox" width="100" height="100"  title="Image Title"></a><img src="apps/<%=appicon%>" alt="" width="100" height="100" class="img-responsive"></td><td width="250"><%=appname%></td><td width="250"><a href="<%=appurl%>">PLAY GAME</a></td></tr>
